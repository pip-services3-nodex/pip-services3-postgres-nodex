    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return new Promise((resolve, reject) => {
                    pool.connect((err, client, release) => {
                        if (err != null || client == null) {
                            err = new pip_services3_commons_nodex_2.ConnectionException(correlationId, "CONNECT_FAILED", "Connection to postgres failed").withCause(err);
                            reject(err);
                            return;
                        }
                ...
                throw new pip_services3_commons_nodex_2.ConnectionException(correlationId, "CONNECT_FAILED", "Connection to postgres failed").withCause(ex);
            }
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                this._connection.end((err) => {
                    if (err) {
                        err = new pip_services3_commons_nodex_2.ConnectionException(correlationId, 'DISCONNECT_FAILED', 'Disconnect from postgres failed: ').withCause(err);
                        reject(err);
                        return;
                    }
